...
public class EmployeeDao {
	...
	public int saveEmployee(Employee e) {
		String myQuery = "insert into employee values('"+e.getId()+"','"+e.getName()+"')";
		return jdbcTemplate.update(myQuery);
	}
	public int updateEmployee(Employee e) {
		String myQuery = "update employee set name='"+e.getName()+"' where id='"+e.getId()+"'";
		return jdbcTemplate.update(myQuery);
	}
	public int deleteEmployee(Employee e) {
		String myQuery = "delete from employee where id="+e.getId()+"";
		return jdbcTemplate.update(myQuery);
	}
